...
# Install cmake from compiled release b/c the rocky linux repo resolves to version 3.20
...
# Install qemu from source b/c rocky linux repo doesn't seem to have one
